...
def parse_opts():
    ...
    parser.add_argument('--dependency_rows', default = False, type = bool, help = 'operate the dependency rows')
    parser.add_argument('--dependency_cols', default = False, type = bool, help = 'operate the dependency cols')
    ...
    parser.add_argument('--read_bounds',default = True, type = bool, help = 'read the bounds')
